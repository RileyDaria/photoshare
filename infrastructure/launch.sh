...
mapfile -t instancesARR < <(euca-run-instances -g default -k $1 -t c1.medium -n 1 -f photoshare/infrastructure/instance-env.sh emi-c87b2863 | grep instance | sed "s/|//g" | tr -d ' ' | sed "s/instance//g")
